    ...
    <div id="PageViewAnimationCss" ref={setContainer}>
      ...
      {selectedKeys.length && selectedKeys[0] === '1' && (
        <div className="right-div">
          ...
          <Row gutter={15} className="right-div-row">
            <Col span={8} className=" right-div-col">
            ...
            <Col span={16} className=" right-div-col">
          ...
          <Row gutter={20} className="">
            <Col span={24} className=" right-div-col">
              <Card title="transition的使用注意" bordered={false}>
          ...
          <Row gutter={20} className="">
            <Col span={24} className=" right-div-col">
              <Card title="transition的局限" bordered={false}>
                <Space direction="vertical">
